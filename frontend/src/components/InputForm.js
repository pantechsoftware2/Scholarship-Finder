...
function InputForm({ onCalculate, loading, error }) {
  ...
  const filteredMajors = useMemo(() => {
    ...
    return MAJOR_SUGGESTIONS.filter((major) =>
  ...
  const handleSubmit = (e) => {
    ...
    if (!formData.gpa || !formData.major.trim() || formData.target_countries.length === 0) {
      setToastMessage('Please complete GPA, major, and at least one target country.');
      return;
    }

    const cleanTestScores = Object.fromEntries(
      Object.entries(formData.test_scores || {}).filter(
    ...
    const coercedProfile = {
      ...
      test_scores:
        Object.keys(cleanTestScores).length > 0
          ? Object.fromEntries(
              Object.entries(cleanTestScores).map(([key, value]) => [
                key,
                Number.isNaN(Number(value)) ? value : Number(value),
              ])
            )
          : null,
      target_countries: Array.isArray(formData.target_countries)
      ...
      <div className="landing-container">
        <div className="hero-section">
          ...
          <p className="hero-subtitle">
            Stop wasting time on applications where you don't stand a chance. Our algorithm analyzes
            your unique profile against thousands of opportunities to find your highest-probability
            matches.
          </p>
            ...
            {loading ? (
              ...
              <form onSubmit={handleSubmit} className="form">
                ...
                <div className="form-group major-group">
                  <label htmlFor="major">
                    <BookOpen size={16} /> Major/Field of Study *
                  </label>
                  <div className="input-with-icon">
                    <input
                      id="major"
                  ...
                  <span className="field-help">
                    Pick a suggested major or type your own manually.
                  </span>
                </div>
                ...
                <div className="form-group">
                  <label className="toggle-label">
                    ...
                    <span className="toggle-copy">
                      <Award size={16} /> I have test scores (GRE/GMAT/IELTS)
                    </span>
                  </label>
                </div>
                ...
                <div className="form-group">
                  <label htmlFor="profile_highlight">
                    <Sparkles size={16} /> Profile Highlight (Max 140 chars)
                  </label>
                  <textarea
